...
#define STRING_CONFIG_H_AUTHOR "(oxi, Alfawise U30 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Alfawise U30 Pro"
...
#if ENABLED(U30_Pro) && DISABLED(U30_Pro_AutoBed)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31, -26, -0.5 } //{ 10, 10, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define MESH_EDIT_GFX_OVERLAY   // Display a graphics overlay while editing the mesh
    ...
    #define GRID_MAX_POINTS_X 5//7      // Don't use more than 15 points per axis, implementation limited.
  #else
...
#define LEVEL_BED_CORNERS
   ...
   */
  #define LEVEL_CORNERS_LEVELING_ORDER { LF, RB, LB, RF }
#endif
